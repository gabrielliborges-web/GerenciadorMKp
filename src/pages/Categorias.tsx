        ...
        return (
            <div className="flex h-full items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-text-secondary-light dark:text-white/60">Carregando categorias...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="w-full h-auto p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="min-w-0 flex-1">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary-light dark:text-white break-words">Categorias</h1>
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-text-secondary-light dark:text-white/60">
