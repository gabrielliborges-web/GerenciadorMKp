    ...
    return (
        <div className="rounded-2xl border border-mauve-light-6 dark:border-white/10 bg-gradient-to-br from-mauve-light-2 dark:from-white/5 to-mauve-light-1 dark:to-white/2 p-6 backdrop-blur-sm">
            <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-text-secondary-light dark:text-white/60">Últimas transações</p>
            </div>

            <div className="space-y-3">
                {movimentos.length === 0 ? (
                    <p className="text-sm text-text-secondary-light dark:text-white/60 text-center py-4">
                    ...
                    movimentos.map((movimento) => {
                        ...
                        return (
                            <div
                                key={movimento.id}
                                className="group flex items-center gap-4 rounded-xl border border-mauve-light-5 dark:border-white/10 bg-mauve-light-1 dark:bg-white/5 p-4 transition-all duration-300 hover:border-mauve-light-7 dark:hover:border-white/20 hover:bg-mauve-light-2 dark:hover:bg-white/10"
                            >
                                <div
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="truncate text-sm font-semibold text-text-primary-light dark:text-white">
                                        {movimento.descricao}
                                    </p>
