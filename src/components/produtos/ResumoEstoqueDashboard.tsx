    ...
    return (
        <div className="mb-8">
            <button
                ...
                aria-expanded={open}
                onClick={() => setOpen((v) => !v)}
                className="mb-4 w-full flex items-center justify-between gap-3 rounded-lg border border-mauve-light-6 dark:border-white/10 bg-mauve-light-2 dark:bg-white/5 px-4 py-3 text-left transition hover:bg-mauve-light-3 dark:hover:bg-white/10"
            >
                <div>
            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    <div className="rounded-xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 p-5">
                        <p className="text-sm font-semibold text-text-secondary-light dark:text-white/80">Vender todo o estoque (preço normal)</p>
                    ...
                    <div className="rounded-xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 p-5">
                        <p className="text-sm font-semibold text-text-secondary-light dark:text-white/80">Vender todo o estoque (preço promocional)</p>
                    ...
                    <div className="rounded-xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 p-5">
                        <p className="text-sm font-semibold text-text-secondary-light dark:text-white/80">Desconto potencial</p>
                    ...
                    <div className="rounded-xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 p-5">
                        <p className="text-sm font-semibold text-text-secondary-light dark:text-white/80">Produtos ativos / Itens</p>
                ...
                {totalPorCategoria.length > 0 && (
                    <div className="mt-6 rounded-xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 p-5">
                        <p className="text-sm font-semibold text-text-secondary-light dark:text-white/80">Valor por categoria (preço normal)</p>
                            ...
                            {totalPorCategoria.map((cat) => (
                                <div key={cat.key} className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="h-3 w-full rounded bg-mauve-light-2 dark:bg-white/5 overflow-hidden">
                                            <div
