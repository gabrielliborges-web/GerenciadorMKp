...
export default function ProdutoList({
    ...
    return (
        <div className="hidden md:block overflow-x-auto rounded-2xl border border-mauve-light-6 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-sm">
            {/* Selection bar */}
            {selectedIds && selectedIds.size > 0 && (
                <div className="border-b border-mauve-light-6 dark:border-white/10 p-3 lg:p-4 bg-mauve-light-2 dark:bg-white/5 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-2 px-3 lg:px-4 py-1.5 lg:py-2 text-xs lg:text-sm font-semibold rounded-lg bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-500/30 transition-all duration-300"
                        >
                        ...
                        <button
                            ...
                            className="px-3 lg:px-4 py-1.5 lg:py-2 text-xs lg:text-sm font-semibold rounded-lg bg-mauve-light-3 dark:bg-white/10 text-text-secondary-light dark:text-white/70 hover:bg-mauve-light-4 dark:hover:bg-white/20 transition-all duration-300"
                        >
                            Cancelar
                        </button>
                    </div>
            ...
            <table className="w-full text-sm">
                    ...
                    <tr className="border-b border-mauve-light-6 dark:border-white/10">
                        <th className="px-4 lg:px-6 py-3 lg:py-4">
                            <input
                                ...
                                className="h-4 w-4 cursor-pointer rounded border-primary-light-6 dark:border-primary-dark-6 bg-primary-light-2 dark:bg-primary-dark-2 text-primary-light-11 dark:text-primary-dark-9 transition-colors"
                ...
                <tbody className="divide-y divide-mauve-light-6 dark:divide-white/10">
                        ...
                        return (
                            ...
                            <>
                                <tr
                                    ...
                                    className={`group transition-all duration-300 hover:bg-mauve-light-2 dark:hover:bg-white/5 cursor-pointer ${rowSelected ? 'bg-primary-light-2 dark:bg-primary-dark-2' : ''}`}
                                >
                                    ...
                                    <td className="px-6 py-4 text-sm font-semibold text-text-primary-light dark:text-white">
                                    ...
                                    <td className="px-6 py-4">
                                        {produto.estoque <= 5 ? (
                                            <div className="inline-flex items-center gap-2 rounded-full bg-yellow-100 dark:bg-yellow-500/20 px-3 py-1 text-sm font-semibold text-yellow-700 dark:text-yellow-400">
                                                <AlertTriangle className="h-4 w-4 text-yellow-700 dark:text-yellow-400" />
                                                Estoque baixo
                                            </div>
                                        ) : (
                                            <span className="text-sm text-text-secondary-light dark:text-white/60">-</span>
                                        )}
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="rounded-lg p-2 transition-all duration-300 hover:bg-primary-light-2 dark:hover:bg-primary-dark-2"
                                                title="Detalhes"
                                            >
                                                <Info className="h-4 w-4 text-primary-light-11 dark:text-primary-dark-9" />
                                            </button>
                                            <button
                                                ...
                                                title="Editar"
                                            >
                                                <Edit className="h-4 w-4 text-text-secondary-light dark:text-white/70" />
                                            </button>
                                            <button
                                ...
                                {isExpanded && (
                                    <tr className="bg-transparent">
                                        <td colSpan={numeroColunas} className="px-6 py-4">
                                            <div className="bg-mauve-light-2 dark:bg-white/5 border border-mauve-light-6 dark:border-white/10 rounded-xl p-4 mt-2">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    {/* Coluna esquerda: resumo do produto e preços */}
                                                    <div>
                                                        <h3 className="text-sm font-semibold text-text-primary-light dark:text-white">Resumo do produto</h3>
                                                        <p className="mt-2 text-sm text-text-secondary-light dark:text-white/80">{produto.nome}</p>
                                                        <p className="text-xs text-text-secondary-light dark:text-white/60">Categoria: {produto.categoria?.nome || "-"} • Status: {produto.ativo ? "Ativo" : "Inativo"} • Estoque: {produto.estoque}</p>

                                                        <div className="mt-4">
                                                            <h4 className="text-sm font-semibold text-text-primary-light dark:text-white">Preços & Estoque</h4>
                                                            <div className="mt-2 space-y-1 text-sm text-text-secondary-light dark:text-white/80">
                                                    ...
                                                    <div>
                                                        <h4 className="text-sm font-semibold text-text-primary-light dark:text-white">Análise financeira</h4>
                                                        <div className="mt-2 space-y-2 text-sm text-text-secondary-light dark:text-white/80">
                                                            <div>
                                                                <div className="text-xs text-text-secondary-light dark:text-white/60">Margem unitária (preço normal)</div>
                                                            ...
                                                            <div>
                                                                <div className="text-xs text-text-secondary-light dark:text-white/60">Margem unitária (promocional)</div>
                                                        ...
                                                        <div className="mt-4">
                                                            <h4 className="text-sm font-semibold text-text-primary-light dark:text-white">Alertas / Insights</h4>
                                                            <ul className="mt-2 list-disc list-inside text-sm text-text-secondary-light dark:text-white/80 space-y-1">
                                                                {alerts.map((a, idx) => (
                                                                    <li key={idx} className={a.startsWith("⚠️") ? "text-red-700 dark:text-red-400" : "text-text-secondary-light dark:text-white/80"}>{a}</li>
                                                                ))}
                                                            </ul>
                                                        </div>
                                                    </div>
