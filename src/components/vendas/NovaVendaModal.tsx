                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button
                            ...
                            className="flex-1 rounded-lg bg-gradient-to-r from-green-600 to-green-700 px-4 py-2 font-semibold text-white transition-all duration-300 hover:shadow-lg hover:shadow-green-500/50 disabled:opacity-50"
                        >
